...
public class ObjektuTransformacija : MonoBehaviour {
	...
	void Update () {
		//Ja ir vilkts kads objekts tad to vares koriget
		...
		if (objektuSkripts.pedejaisVilktais != null) {
			...
			if(Input.GetKey(KeyCode.UpArrow)){
				if(objektuSkripts.pedejaisVilktais.GetComponent<RectTransform> ().localScale.y <= 0.8f){
					...
					= new Vector2 (objektuSkripts.pedejaisVilktais.GetComponent<RectTransform> ().localScale.x, objektuSkripts.pedejaisVilktais.GetComponent<RectTransform> ().localScale.y + 0.001F);
}
	}
			...
			if(Input.GetKey(KeyCode.LeftArrow)){
				if(objektuSkripts.pedejaisVilktais.GetComponent<RectTransform> ().localScale.y >= 0.3f){
					objektuSkripts.pedejaisVilktais.GetComponent<RectTransform> ().localScale
					= new Vector2 (objektuSkripts.pedejaisVilktais.GetComponent<RectTransform> ().localScale.x-0.001F, objektuSkripts.pedejaisVilktais.GetComponent<RectTransform> ().localScale.y);
				}
			}
